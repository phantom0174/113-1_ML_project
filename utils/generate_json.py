...
root_dir = "./archive/PRINTED_TEX_230k"

with open(f'{root_dir}/corresponding_png_images.txt', 'r', encoding='utf-8') as images_file:
    images = images_file.readlines()

with open(f'{root_dir}/final_png_formulas.txt', 'r', encoding='utf-8') as formulas_file:
